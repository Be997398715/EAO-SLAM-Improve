...
public:
    ...
    Frame(const cv::Mat &imRGB, const cv::Mat &imDepth, const cv::Mat &imGray, const double &timeStamp, ORBextractor* extractor,line_lbd_detect* line_lbd_ptr_frame,ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth);
