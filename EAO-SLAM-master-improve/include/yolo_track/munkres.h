...
public:
    ...
    static void replace_infinites(Matrix_<Data> &matrix) {
    ...
    static void minimize_along_direction(Matrix_<Data> &matrix, const bool over_columns) {
