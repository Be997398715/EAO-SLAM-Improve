...
int main(int argc, char **argv)
{
    if(argc != 6)
    {
        cerr << endl << "Usage: ./mono_tum option path_to_sequence path_to_vocabulary path_to_settings online"
        << endl << "Note : only Full for all images of sequence" << endl <<
        "online for real-time yolo(detector or tracker depends on 'define DEEP_SORT' in yolov3.h)" << endl;
        // ./Examples/Monocular/mono_tum Full /media/wu/A/A-Study/Datasets/tum/rgbd_dataset_freiburg3_long_office_household/  Vocabulary/ORBvoc.bin Examples/Monocular/TUM3.yaml online
        return 1;
    }
    ...
    cout << "online is "<<online <<endl;
    // Create SLAM system. It initializes all system threads and gets ready to process frames.
    ORB_SLAM2::System SLAM(VocFile, YamlFile, argv[1], ORB_SLAM2::System::MONOCULAR, true, online);
