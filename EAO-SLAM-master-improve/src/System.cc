...
System::System(const string &strVocFile, const string &strSettingsFile, 
               ...
               const bool bUseViewer, const bool SemanticOnline  // [EAO] online/offline yolo detection
               ):  mSensor(sensor),
                   mbReset(false),
...

{
    ...
    if(mSensor!=System::MONOCULAR)
        mpPointCloudMapping = make_shared<PointCloudMapping>( 0.05 );
    ...
    if(mSensor!=System::MONOCULAR)
        mpTracker = new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer,
                             mpMap, mpPointCloudMapping, mpKeyFrameDatabase, strSettingsFile, mSensor, flag);
    else
        mpTracker = new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer,
