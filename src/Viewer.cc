...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuShowPointCloud_Octomap("menu.menuShowPointCloud_Octomap", false, false);
...
//            s_cam.SetModelViewMatrix(pangolin::ModelViewLookAt(mViewpointX,mViewpointY,mViewpointZ, 0,0,0,0.0,-1.0, 0.0));
        ...
        // ---- draw octomap and plan ---- //
        if(menuShowPointCloud_Octomap){
